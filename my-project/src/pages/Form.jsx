...
const Form = () => {
  ...
  return (
    <div className=" text-white h-213 ">
      ...
      <form className=' flex flex-col mt-4 min-w-1/3' >
        <div className='mx-auto justify-center md:w-1/3 w-[90%] lg-[70%]'>
          ...
          <div className='mt-9'>
            ...
            <input type='text' className='rounded-lg bg-[rgba(217,217,217,0.2)] mt-3 min-w-full h-8  pl-2 pt-0.5 pb-1.5 text-blue-200'/>
          </div>
          <div className='mt-3'>
            <label className='justify-self-start font-serif'>Email Address</label>
            <input type='text' className='rounded-lg bg-[rgba(217,217,217,0.2)] mt-2 min-w-full h-8  pl-2 pt-0.5 pb-1.5 text-blue-200'/>
          </div>
          <div className='mt-3'>
      ...
      >
        <option className='bg-blue-950'  value="">Select Track</option>
        <option className='bg-blue-950' value="frontend">Frontend</option>
        <option className='bg-blue-950' value="backend">Backend</option>
        <option className='bg-blue-950' value="cloud">Cloud</option>
        <option className='bg-blue-950' value="data">Data</option>
        <option className='bg-blue-950' value="engineering">Engineering</option>
      </select>
          </div>
          <div className='mt-3'>
            <label className='justify-self-start font-serif'>LinkedIn</label>
            <input type='text' className='rounded-lg bg-[rgba(217,217,217,0.2)] mt-2 min-w-full h-8  pl-2 pt-0.5 pb-0.5 text-blue-200' />
          </div>
          <div className='mt-3'>
            <label className='justify-self-start font-serif'>Personal Quote or Message (optional)</label>
            <textarea className='rounded-lg bg-[rgba(217,217,217,0.2)] mt-2 min-w-full h-20 pl-2 pt-1 text-xs text-blue-200'/>
          </div>
