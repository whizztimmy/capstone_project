    ...
    return (
        <div className=" text-white ">
            ...
            <div className='mx-auto justify-items-center text-center'>
                <h1 className='text-[min(5vw,30px)] text-center mt-4 font-extrabold text-balance w-2/3 '>Congrats, <span className='text-red-300'>Timothy Adetunji</span>!
                    Your Graduation Ticket is ready.</h1>
                <p className='text-[15px] mt-6 text-xs font-thin text-balance  w-2/3 sm:w-60 lg:w-80 md:w-70'>We've emailed your ticket to <span className='text-red-400'>Adetunjitimothy7@gmail.com</span> and will keep you updated as the big day approaches.</p>
            </div>
                ...
                <div className=' relative w-[85%] sm:w-[70%] lg:w-[40%] justify-items-center'><img src='/pattern-ticket.svg' alt='pattern-ticket' className='relative w-full' />
                    <div className='absolute top-2 left-3'>
                        <div className='flex flex-row'> <img src={graduationCap} className="w-5 h-5" alt="graduation Cap" />
                            ...
                            <p className='absolute top-4 left-8 text-[12px] mt-2'>June 15, 2025 /  Lagos, NG</p>
                        </div>
                    </div>
                    <img src='/image-avatar.jpg' className='w-[30px] rounded-md absolute bottom-4 left-3' />
                    <h3 className='bottom-8 left-13 absolute text-red-100 text-xs '>Timothy Adetunji</h3>
                    <img src={graduationCap} className="w-4 absolute bottom-4 left-12 stroke-[rgba(126,105,105,0.98)]" alt="graduation Cap" />
                    <p className='absolute bottom-4 left-17 font-thin text-xs'>Frontend Development</p>
